...
import { addToCart, getCartMessageStatus, setCartMessageOff } from '../../store/cartSlice';
...
const ProductSinglePage = (): JSX.Element => {
  ...
  const addToCartHandler = (product: IProduct) => {
    ...
    const cartItem: ICartItem = { ...product, quantity: quantity, totalPrice, discountedPrice } as ICartItem;
